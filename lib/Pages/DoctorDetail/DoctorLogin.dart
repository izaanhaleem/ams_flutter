...
class DoctorDesignLogin extends StatefulWidget {
  const DoctorDesignLogin({Key? key}) : super(key: key);

  @override
  _DoctorDesignLoginState createState() => _DoctorDesignLoginState();
}

class _DoctorDesignLoginState extends State<DoctorDesignLogin> {
  GlobalKey<FormState> globalFormKey = GlobalKey<FormState>();
  final LoginController controller = Get.put(LoginController());
  late LoginRequest loginRequest;
  bool isApiCallProcess = false;
  var _nameTextController = TextEditingController(text: "arslanzafar250@gmail.com");
                                              ...
                                              if (_formKey.currentState!.validate()) {
                                                ...
                                                if (error != "") {
                                                  ...
                                                  Navigator.of(context).pushAndRemoveUntil(
                                                      MaterialPageRoute(builder: (context)=>Navigation()), (Route<dynamic>route) => false);
                                                }
                                              }
                                            },
                                            child: Text(
